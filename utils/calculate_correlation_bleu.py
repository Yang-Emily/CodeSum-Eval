...
if __name__ == '__main__':
    ...
    # , "geometric_mean"]
    human_annotation = pd.read_excel("../dataset/human_evaluation/RQ1-2/human_evaluation_1.xlsx")
    ...
    diff_score = pd.read_excel("../dataset/RQ1-2/score_bleu.xlsx")
    ...
    # human_avg = human_annotation["Coherence"].tolist()
    human_avg = human_annotation["Consistency"].tolist()
    # human_avg = human_annotation["Fluency"].tolist()
    # human_avg = human_annotation["Relevance"].tolist()
    # human_avg = human_annotation["Sematic"].tolist()
